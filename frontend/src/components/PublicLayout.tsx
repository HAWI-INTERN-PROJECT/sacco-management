        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-[#0B6B3A]">SACCO Manager</span>
            </Link>
      ...
      <footer className="bg-[#1F2937] text-slate-300 pt-16 pb-8 border-t-4 border-[#0B6B3A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
            ...
            <div className="lg:col-span-2">
              <Link to="/" className="flex items-center gap-2 mb-6">
                ...
                <span className="text-2xl font-bold text-white">SACCO Manager</span>
              </Link>
            ...
            <div>
              <h3 className="text-white font-semibold mb-4 uppercase tracking-wider text-xs">Product</h3>
              <ul className="space-y-3 text-sm">
          ...
          <div className="border-t border-slate-700 pt-8 flex flex-col lg:flex-row justify-between items-center gap-6 text-sm text-slate-500">
            <p className="order-2 lg:order-1">© {new Date().getFullYear()} SACCO Manager. All rights reserved.</p>
            ...
            <div className="order-1 lg:order-2 flex items-center gap-3 group cursor-pointer hover:opacity-90 transition-opacity">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[#C62828] font-bold text-2xl tracking-tighter leading-none font-sans">][</span>
                <div className="flex flex-col justify-center">
                  <span className="text-white font-serif text-xl tracking-wider leading-none" style={{ fontFamily: 'Times New Roman, serif' }}>HAWI</span>
                  <span className="text-[9px] text-slate-400 uppercase tracking-[0.2em] mt-1 leading-none">Software Solutions</span>
                </div>
              </div>
            </div>
