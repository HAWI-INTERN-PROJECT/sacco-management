          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                ...
                <span className="text-[#de7356]">Cooperative</span> Economy
              </h1>
              <p className="text-green-100 text-lg md:text-xl mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Bridging the gap between traditional community values and modern
                financial technology. The ultimate digital platform for
                Ethiopian SACCOs to securely manage members, scale savings, and
                drive local growth.
              </p>
            ...
            >
              <div className="relative w-full max-w-md aspect-square bg-gradient-to-tr from-green-50 to-emerald-50 dark:from-slate-800 dark:to-slate-900 rounded-3xl p-6 border border-green-100 dark:border-slate-700 shadow-2xl flex items-center justify-center overflow-hidden group">
                {/* Background Glows */}
                <div className="absolute inset-0 bg-gradient-to-tr from-emerald-500/20 to-[#de7356]/20 rounded-[3rem] blur-3xl mix-blend-screen"></div>
                ...
                >
                  ...
                  <div className="p-5 space-y-4">
                    ...
                    <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-100 dark:border-emerald-800/50 flex items-center justify-between">
                      <div>
                        <p className="text-emerald-800 dark:text-emerald-400 text-xs font-semibold mb-1 uppercase tracking-wider">
                          Total Members
                        </p>
                        <p className="text-2xl font-bold text-[#0B6B3A]">
                          {stats?.active_members || 128}
                        </p>
                      </div>
                    ...
                    <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-4 border border-amber-100 dark:border-amber-800/50 flex items-center justify-between">
                      <div>
                        <p className="text-amber-800 dark:text-amber-400 text-xs font-semibold mb-1 uppercase tracking-wider">
                          Total Savings
                        </p>
                        <p className="text-2xl font-bold text-amber-600">
                          {stats?.birr_managed
                            ? (stats.birr_managed / 1000000).toFixed(1) + "M"
                            : "1.8M"}{" "}
      ...
      <section className="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              {
                value: stats?.saccos_registered || 12,
                suffix: "+",
                label: "SACCOs Registered",
              },
              {
                value: stats?.active_members || 850,
                suffix: "+",
                label: "Active Members",
              },
              {
                value: stats?.birr_managed ? stats.birr_managed / 1000000 : 4,
                suffix: "M+",
                label: "Birr Managed",
              },
          ...
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-lg">
                Our platform provides comprehensive tools for every aspect of
            ...
            {[
              {
                ...
                desc: "Complete KYC profiles, automated activity tracking, and detailed member analytics.",
                color: "green",
              },
              {
                icon: Wallet,
                title: "Savings & Deposits",
                desc: "Real-time ledger updates, automated interest calculations, and multiple account types.",
                color: "emerald",
              },
              {
                icon: FileText,
                title: "Loan Processing",
                desc: "Digital applications, multi-tier approval workflows, and credit scoring.",
                color: "blue",
              },
              {
                icon: PieChart,
                title: "Share Capital",
                desc: "Transparent share allocation, ownership tracking, and transfer management.",
                color: "purple",
              },
              {
                icon: Banknote,
                title: "Dividend Distribution",
                desc: "Automated calculations, equitable distribution, and comprehensive reporting.",
                color: "amber",
              },
              {
                icon: ShieldCheck,
                title: "Security & Compliance",
                desc: "Bank-grade encryption, role-based access, and full audit trails.",
                color: "slate",
              },
            ].map((feature, i) => (
              <motion.div
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl bg-${feature.color}-50 dark:bg-${feature.color}-900/30 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}
                >
                  <feature.icon
            ...
            {[
              {
                step: "01",
                title: "Register",
                desc: "Create your SACCO account and set up your organization profile in minutes.",
              },
              {
                step: "02",
                title: "Onboard Members",
                desc: "Invite members, complete KYC verification, and set up individual accounts.",
              },
              {
                step: "03",
                title: "Start Managing",
                desc: "Process savings, approve loans, track dividends, and generate reports.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-lg">
                Hear what our partner SACCOs have to say.
              </p>
            </div>
          </ScrollReveal>
          ...
          >
            {[
              ...
              <motion.div
                key={i}
                variants={fadeInUp}
                className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 h-full flex flex-col"
              >
                <div className="flex-grow">
                  <div className="text-[#de7356] text-2xl mb-4">★★★★★</div>
        ...
        <section className="py-20 bg-[#1E293B] text-center">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <p className="text-slate-400 text-lg mb-10">
              Join hundreds of Ethiopian cooperatives already using SACCO
              Manager to grow their operations.
            </p>
