    ...
    <div className="flex flex-col w-full">
      ...
      <section className="py-20 bg-slate-50 relative -mt-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
             <motion.div variants={fadeInUp} className="bg-white p-10 rounded-2xl shadow-xl shadow-slate-200/50 border-t-4 border-[#0B6B3A]">
                <div className="w-14 h-14 rounded-full bg-green-50 flex items-center justify-center mb-6">
                  <Target className="w-7 h-7 text-[#0B6B3A]" />
                </div>
             ...
             <motion.div variants={fadeInUp} className="bg-white p-10 rounded-2xl shadow-xl shadow-slate-200/50 border-t-4 border-[#10B981]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <ScrollReveal direction="left" className="w-full lg:w-1/2">
               <div className="relative rounded-3xl overflow-hidden aspect-[4/3] bg-gradient-to-br from-[#0B6B3A]/10 to-emerald-100 shadow-2xl flex items-center justify-center">
                 <div className="text-center p-8">
                   <div className="w-20 h-20 mx-auto rounded-full bg-[#0B6B3A]/10 flex items-center justify-center mb-4">
                     <Users className="w-10 h-10 text-[#0B6B3A]" />
                   </div>
                   <p className="text-[#0B6B3A] font-semibold text-lg">Community Driven Finance</p>
                   <p className="text-slate-500 text-sm mt-2">Building trust through technology</p>
                 </div>
               </div>
            </ScrollReveal>

            <ScrollReveal direction="right" className="w-full lg:w-1/2">
               <h2 className="text-3xl md:text-4xl font-bold text-[#1E293B] mb-6">Our Story</h2>
               ...
               <div className="mt-8 space-y-3">
                 <div className="flex items-center gap-3 text-[#0B6B3A] font-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl font-bold text-[#1E293B] mb-4">Our Key Values</h2>
              <p className="text-slate-500">The principles that guide our platform development and our commitment to our partners.</p>
            </div>
          </ScrollReveal>
          ...
          >
            {[
              ...
              <motion.div key={i} variants={fadeInUp} className="bg-white p-8 rounded-2xl text-center border border-slate-100 hover:shadow-lg transition-shadow group">
                <div className={`w-12 h-12 mx-auto rounded-full bg-${val.color}-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                  <val.icon className={`w-6 h-6 text-${val.color}-600`} />
                </div>
                <h3 className="text-lg font-bold text-[#1E293B] mb-3">{val.title}</h3>
